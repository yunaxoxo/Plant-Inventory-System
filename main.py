...
"""
    ...
    Utility Functions:
        i. key errors - done
        ii. invalid inputs - done
        iii. multiple inputs - done
        iv. view
        iv. generate id
        v. get id
        vi. display options
        vii. standardize options
        viii. hashmap of functions
        ix. ask to continue
        x. check if empty
    1. Add Plant Function -- done
        a. plant generator id -- done
        b. check duplicates -- done
        c. check valid input -- done
    2. Delete Plant Function -- done
        a. check if none or empty
    3. View Plant Function -- done
        a. viewAll function
        b. error message for empty or none
    4. Edit Plant Function -- done
        a. check if exists
    5. Update Nourishment Function - done
        a. adding fertilizers to a selected plant
        b. adding to all
        c. updating amount
    6. Nourish Plant Function -- done


    ## Plant Dictionary = {

    Plant_ID : {"name" ; name, "storage" : storage, "nourishment" : nourishment}

    }

    ## For Fertilizer
    1. Purchase Fertilizer Function -- done
        a. ask user for information about the fertilizer
        b. fertilizer counter
        c. update existing fertilizer
        d. log entry
    2. View Fertilizer Function -- done
    3. View All Fertilizer Function -- done
    4. View Affected Plants Function -- done

    ## Fertilizer Dictionary = {
    Fertilizer_ID : {"name" : name, "stock_amount" : stock_amount, "supplier" ; last_supplier}

    }

    ## For Logbook Section
    1. Add Log Entry Function -- done
    2. View All Entries Function -- done
    3. View Transactions per action Function -- done
    4. Data Reset Function -- done

    ## Logbook Dictionary

    Log_ID : {Plant_ID : "Plant_ID" , Fertilizer_ID : "Fertilizer_ID", Date: "Date" , Action; "action"}

    ## Art and File Handling
    1. Ascii Art -- done
    2. Encryption and Decryption -- done
    4. Load and Save File -- done
    3. Load Counter -- done
